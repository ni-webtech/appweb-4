...
/************************************************************************/
/*
 *  Start of file "../../src/core/nCmd.es"
 */
/************************************************************************/
    ...
    class Cmd implements Stream {
        ...
        /**
            ...
            @param cmdline The (optional) command line to initialize with. If a command line is provided, the start()
                method is automatically invoked after teh command is constructed. The cmdline may be either a string or
                an array of strings.
...
MOB - should there be a timeout here
         */
        native function get status(): Number
...
//  MOB - more
        static function XXXdaemon(cmdline: String): Number {
            let cmd = new Cmd
        ...
        native function XXXexec(cmdline: String = null, options: Object = {}): Void
        ...
        /**
            ...
            @throws IOError if the command exits with non-zero status. The exception object will contain the command's
                standard error output. 
         */
        static function XXXrun(cmdline: String, data: String = null): String {
            let cmd = new Cmd
            cmd.start(cmdline)
            if (data) {
                cmd.write(data)
...
MOB - describe throw
         */
        static function XXXsh(command: String, data: String = null): String {
    ...
    //  DOC
    function XXXcmd(cmdline: String, data: String = null): String
        Cmd.sh(cmdline, data)
}
