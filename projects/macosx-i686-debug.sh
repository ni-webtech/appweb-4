...
echo '#!macosx-i686/bin/cgiProgram' >test/cgi-bin/testScript ; chmod +x test/cgi-bin/testScript
...
cp macosx-i686/bin/cgiProgram test/cgi-bin/cgiProgram
cp macosx-i686/bin/cgiProgram test/cgi-bin/nph-cgiProgram
cp macosx-i686/bin/cgiProgram 'test/cgi-bin/cgi Program'
cp macosx-i686/bin/cgiProgram test/web/cgiProgram.cgi
