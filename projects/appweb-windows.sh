...
"${LD}" -out:${CONFIG}\bin\testAppweb.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}\obj\testAppweb.obj ${CONFIG}\obj\testHttp.obj ${LIBS} libappweb.lib libhttp.lib libmpr.lib libpcre.lib
