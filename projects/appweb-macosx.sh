...
${CC} -dynamiclib -o ${CONFIG}/bin/libhttp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.0.0 -current_version 4.0.0 ${LIBPATHS} -install_name @rpath/libhttp.dylib ${CONFIG}/obj/httpLib.o ${LIBS} -lmpr -lpcre -lmprssl
...
${CC} -dynamiclib -o ${CONFIG}/bin/mod_proxy.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.0.0 -current_version 4.0.0 ${LIBPATHS} -install_name @rpath/mod_proxy.dylib ${CONFIG}/obj/proxyHandler.o ${LIBS} -lappweb -lhttp -lmpr -lpcre -lmprssl
