...
echo '#!linux-i686/bin/cgiProgram' >test/cgi-bin/testScript ; chmod +x test/cgi-bin/testScript
...
cp linux-i686/bin/cgiProgram test/cgi-bin/cgiProgram
cp linux-i686/bin/cgiProgram test/cgi-bin/nph-cgiProgram
cp linux-i686/bin/cgiProgram 'test/cgi-bin/cgi Program'
cp linux-i686/bin/cgiProgram test/web/cgiProgram.cgi
